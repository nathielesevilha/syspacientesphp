  ...
  <div class="container">
    ...
    <div class="jumbotron">
      ...
      <div class="text-center">
        <a class="btn-lg btn btn-success" style="margin: 0 auto;" href="pessoa.php">Adicionar Pessoa</a>
      </div>
      <br>
      <table class="table">
        <thead>
        ...
        <tbody>
          <?php
          $sql = "SELECT idPessoa, nome, datanascimento FROM pessoas ORDER BY idPessoa";
          $resp = mysqli_query($conexao_bd, $sql);
          while ($rows = mysqli_fetch_row($resp)) {
            ...
            echo ("<td>" . ucwords(strtolower($nome)) . "</td>");
            echo ("<td>$email</td>");
            echo ("<td>");
            echo ("<a class='btn btn-success' href='pessoa.php?idPessoa=$id' role='button'>Editar</a>&nbsp;");
            echo ("<a class='btn btn-danger'  href='javascript:excluirUsuario($id)' role='button'>Excluir</a>&nbsp;");
            echo ("</td>");
            echo ("</tr>");
          }
          ?>
